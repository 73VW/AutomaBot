...
- le token du bot Discord, que l'on peut récuperer sur Discord (`getting Discord token`_)
- le host
- le port
...
.. _getting Discord token: https://github.com/reactiflux/discord-irc/wiki/Creating-a-discord-bot-&-getting-a-token
